...
## Project Structure
    ...
    ├── staging_application_91319  # Django project configurations
...
1. Clone this repo and `cd staging_application_91319`
...
2. Clone this repo and `cd staging_application_91319`
